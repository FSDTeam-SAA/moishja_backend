...
export const getAllFastRemovalRequestsService = async () => {
    return await FastRemovalRequest.find().populate('userId', 'firstName lastName email');
}
export const getFastRemovalRequestByIdService = async (id) => {
    return await FastRemovalRequest.findById(id).populate('userId', 'firstName lastName email');
}
...
export const getFastRemovalRequestByUserIdService = async (userId) => {
    return await FastRemovalRequest.find({ userId: userId }).populate('userId', 'firstName lastName email');
}